...
class Test_vlan_state_removed_from_middle_of_table:
    ...
    def test_verifyConfVlans(self):
        ...
        if verifyVlan(self.dut01Obj, 3, 1) != 0:
            ...
            LogOutput('info', "Passed validating repeated vlan " + str(3))
        # Verify vlan 4
        if verifyVlan(self.dut01Obj, 4, 1) != 0:
            ...
            LogOutput('info', "Passed validating repeated vlan " + str(4))
    ...
    def test_delete_middle_vlan(self):
        LogOutput('info', "############################################")
        LogOutput('info', "Step 8- Delete middle vlan from table")
        LogOutput('info', "############################################")
    ...
    def test_deleted_vlan(self):
        ...
        LogOutput('info', "############################################")
        if verifyVlan(self.dut01Obj, 3) != 0:
            LogOutput('error',
