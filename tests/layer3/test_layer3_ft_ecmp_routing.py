...
def ecmp_ping(**kwargs):
    ...
    retStruct = InterfaceEnable(deviceObj=switch2, enable=True,
                                interface=switch2.linkPortMapping['lnk04'])
    retCode = retStruct.returnCode()
    if retCode != 0:
        assert "Unable to enable interafce on SW1"
        # caseReturnCode = 1
    ...
    retStruct = InterfaceEnable(deviceObj=switch1, enable=True,
                                interface=switch1.linkPortMapping['lnk05'])
    retCode = retStruct.returnCode()
    if retCode != 0:
        assert "Unable to enable interafce on SW1"
        # caseReturnCode = 1
    ...
    LogOutput('info', "Enabling interface2 on SW2")
    retStruct = InterfaceEnable(deviceObj=switch2, enable=True,
                                interface=switch2.linkPortMapping['lnk05'])
    retCode = retStruct.returnCode()
    if retCode != 0:
        assert "Unable to enable interafce on SW1"
        # caseReturnCode = 1
    ...
    retStruct = InterfaceIpConfig(deviceObj=switch1,
                                  interface=switch1.linkPortMapping['lnk03'],
                                  addr="10.0.20.2", mask=24, config=True)
    retCode = retStruct.returnCode()
    if retCode != 0:
        assert "Failed to configure an ipv4 address"
        # caseReturnCode = 1
    ...
    retStruct = InterfaceIpConfig(deviceObj=switch2,
                                  interface=switch2.linkPortMapping['lnk04'],
                                  addr="1040::2", mask=120, ipv6flag=True,
                                  config=True)
    retCode = retStruct.returnCode()
    if retCode != 0:
        assert "Failed to configure an ipv6 address"
    ...
    retStruct = InterfaceIpConfig(deviceObj=switch1,
                                  interface=switch1.linkPortMapping['lnk05'],
                                  addr="10.0.50.1", mask=24, config=True)
    retCode = retStruct.returnCode()
    if retCode != 0:
        assert "Failed to configure an ipv4 address"
        # caseReturnCode = 1
    ...
    retStruct = InterfaceIpConfig(deviceObj=switch1,
                                  interface=switch1.linkPortMapping['lnk05'],
                                  addr="1050::1", mask=120, ipv6flag=True,
                                  config=True)
    retCode = retStruct.returnCode()
    if retCode != 0:
        assert "Failed to configure an ipv6 address"
    ...
    retStruct = InterfaceIpConfig(deviceObj=switch2,
                                  interface=switch2.linkPortMapping['lnk05'],
                                  addr="10.0.50.2", mask=24, config=True)
    retCode = retStruct.returnCode()
    if retCode != 0:
        assert "Failed to configure an ipv4 address"
        # caseReturnCode = 1
    ...
    retStruct = InterfaceIpConfig(deviceObj=switch2,
                                  interface=switch2.linkPortMapping['lnk05'],
                                  addr="1050::2", mask=120, ipv6flag=True,
                                  config=True)
    retCode = retStruct.returnCode()
    if retCode != 0:
        assert "Failed to configure an ipv6 address"
    ...
    retStruct = IpRouteConfig(deviceObj=switch1, route="1040::0", mask=120,
                              nexthop="1030::2", config=True, ipv6flag=True)
    retCode = retStruct.returnCode()
    if retCode:
    ...
    retStruct = IpRouteConfig(deviceObj=switch2, route="1010::0", mask=120,
                              nexthop="1030::1", config=True, ipv6flag=True)
    retCode = retStruct.returnCode()
    if retCode:
        LogOutput('error', "\nFailed to configure ipv6 address route")
        # caseReturnCode = 1

    retStruct = IpRouteConfig(deviceObj=switch2, route="10.0.20.0", mask=24,
                              nexthop="10.0.30.1", config=True)
    retCode = retStruct.returnCode()
    if retCode:
        LogOutput('error', "\nFailed to configure ipv4 address route")
    ...
    retStruct = IpRouteConfig(deviceObj=switch2, route="1020::0", mask=120,
                              nexthop="1030::1", config=True, ipv6flag=True)
    retCode = retStruct.returnCode()
    if retCode:
        LogOutput('error', "\nFailed to configure ipv6 address route")
    ...
    LogOutput('info',
              "\n\n\n####### Configuring switch 1 and 2 static routes #######")
    retStruct = IpRouteConfig(deviceObj=switch1, route="10.0.40.0", mask=24,
                              nexthop="10.0.50.2", config=True)
    retCode = retStruct.returnCode()
    if retCode:
        LogOutput('error', "\nFailed to configure ipv4 address route")
        # caseReturnCode = 1

    retStruct = IpRouteConfig(deviceObj=switch1, route="1040::", mask=120,
                              nexthop="1050::2", config=True, ipv6flag=True)
    retCode = retStruct.returnCode()
    if retCode:
        LogOutput('error', "\nFailed to configure ipv6 address route")
        # caseReturnCode = 1
    ...
    retStruct = IpRouteConfig(deviceObj=switch2, route="10.0.10.0", mask=24,
                              nexthop="10.0.50.1", config=True)
    retCode = retStruct.returnCode()
    if retCode:
        LogOutput('error', "\nFailed to configure ipv4 address route")
        # caseReturnCode = 1

    retStruct = IpRouteConfig(deviceObj=switch2, route="1010::", mask=120,
                              nexthop="1050::1", config=True, ipv6flag=True)
    retCode = retStruct.returnCode()
    if retCode:
        LogOutput('error', "\nFailed to configure ipv6 address route")
        # caseReturnCode = 1
    ...
    retStruct = IpRouteConfig(deviceObj=switch2, route="1020::", mask=120,
                              nexthop="1050::1", config=True, ipv6flag=True)
    retCode = retStruct.returnCode()
    if retCode:
        LogOutput('error', "\nFailed to configure ipv6 address route")
    ...
    retStruct = host1.NetworkConfig(ipAddr="10.0.10.1",
                                    ...
                                    interface=host1.linkPortMapping['lnk02'],
    ...
    retStruct = host2.NetworkConfig(ipAddr="10.0.20.1",
                                    netMask="255.255.255.0",
                                    interface=host2.linkPortMapping['lnk03'],
                                    broadcast="10.0.20.0", config=True)
    retCode = retStruct.returnCode()
    if retCode != 0:
        assert "Failed to configure an ipv4 address"
        # caseReturnCode = 1
    ...
    retStruct = host2.Network6Config(ipAddr="1020::1", netMask=120,
                                     interface=host2.linkPortMapping['lnk03'],
                                     broadcast="1020::0",  config=True)
    retCode = retStruct.returnCode()
    if retCode != 0:
        assert "Failed to configure an ipv6 address"
    ...
    retStruct = host3.NetworkConfig(ipAddr="10.0.40.1",
                                    netMask="255.255.255.0",
                                    interface=host3.linkPortMapping['lnk04'],
                                    broadcast="10.0.40.0", config=True)
    retCode = retStruct.returnCode()
    if retCode != 0:
        assert "Failed to configure an ipv4 address"
        # caseReturnCode = 1
    ...
    retStruct = host3.Network6Config(ipAddr="1040::1", netMask=120,
                                     interface=host3.linkPortMapping['lnk04'],
                                     broadcast="1040::0",  config=True)
    retCode = retStruct.returnCode()
    if retCode != 0:
        assert "Failed to configure an ipv6 address"
    ...
    retStruct = host1.IPRoutesConfig(config=True, destNetwork="10.0.30.0",
                                     netMask=24, gateway="10.0.10.2")
    retCode = retStruct.returnCode()
    if retCode:
        LogOutput('error', "\nFailed to configure ipv4 address route")
        # caseReturnCode = 1
    ...
    LogOutput('info', "Configuring routes on the workstations")
    retStruct = host1.IPRoutesConfig(config=True, destNetwork="10.0.40.0",
                                     netMask=24, gateway="10.0.10.2")
    retCode = retStruct.returnCode()
    if retCode:
        LogOutput('error', "\nFailed to configure ipv4 address route")
    ...
    retStruct = host1.IPRoutesConfig(config=True, destNetwork="1040::0",
                                     netMask=120, gateway="1010::2",
                                     ipv6Flag=True)
    retCode = retStruct.returnCode()
    if retCode:
    ...
    LogOutput('info', "Configuring routes on the workstations")
    retStruct = host2.IPRoutesConfig(config=True, destNetwork="10.0.30.0",
                                     netMask=24, gateway="10.0.20.2")
    retCode = retStruct.returnCode()
    if retCode:
        LogOutput('error', "\nFailed to configure ipv4 address route")
        # caseReturnCode = 1

    retStruct = host2.IPRoutesConfig(config=True, destNetwork="1030::0",
                                     netMask=120, gateway="1020::2",
                                     ipv6Flag=True)
    retCode = retStruct.returnCode()
    if retCode:
        LogOutput('error', "\nFailed to configure ipv6 address route")
    ...
    LogOutput('info', "Configuring routes on the workstations")
    retStruct = host2.IPRoutesConfig(config=True, destNetwork="10.0.40.0",
                                     netMask=24, gateway="10.0.20.2")
    retCode = retStruct.returnCode()
    if retCode:
        LogOutput('error', "\nFailed to configure ipv4 address route")
    ...
    retStruct = host2.IPRoutesConfig(config=True, destNetwork="1040::0",
                                     netMask=120, gateway="1020::2",
                                     ipv6Flag=True)
    retCode = retStruct.returnCode()
    if retCode:
    ...
    LogOutput('info', "Configuring routes on the workstations")
    retStruct = host3.IPRoutesConfig(config=True, destNetwork="10.0.30.0",
                                     netMask=24, gateway="10.0.40.2")
    retCode = retStruct.returnCode()
    if retCode:
        LogOutput('error', "\nFailed to configure ipv4 address route")
        # caseReturnCode = 1

    retStruct = host3.IPRoutesConfig(config=True, destNetwork="1030::0",
                                     netMask=120, gateway="1040::2",
                                     ipv6Flag=True)
    retCode = retStruct.returnCode()
    if retCode:
        LogOutput('error', "\nFailed to configure ipv6 address route")
    ...
    LogOutput('info', "Configuring routes on the workstations")
    retStruct = host1.IPRoutesConfig(config=True, destNetwork="10.0.50.0",
                                     netMask=24, gateway="10.0.10.2")
    retCode = retStruct.returnCode()
    if retCode:
        LogOutput('error', "\nFailed to configure ipv4 address route")
    ...
    retStruct = host1.IPRoutesConfig(config=True, destNetwork="1050::0",
                                     netMask=120, gateway="1010::2",
                                     ipv6Flag=True)
    retCode = retStruct.returnCode()
    if retCode:
    ...
    LogOutput('info', "Configuring routes on the workstations")
    retStruct = host2.IPRoutesConfig(config=True, destNetwork="10.0.50.0",
                                     netMask=24, gateway="10.0.20.2")
    retCode = retStruct.returnCode()
    if retCode:
        LogOutput('error', "\nFailed to configure ipv4 address route")
    ...
    retStruct = host2.IPRoutesConfig(config=True, destNetwork="1050::0",
                                     netMask=120, gateway="1020::2",
                                     ipv6Flag=True)
    retCode = retStruct.returnCode()
    if retCode:
    ...
    LogOutput('info', "Configuring routes on the workstations")
    retStruct = host3.IPRoutesConfig(config=True, destNetwork="10.0.50.0",
                                     netMask=24, gateway="10.0.40.2")
    retCode = retStruct.returnCode()
    if retCode:
        LogOutput('error', "\nFailed to configure ipv4 address route")
    ...
    retStruct = host3.IPRoutesConfig(config=True, destNetwork="1050::0",
                                     netMask=120, gateway="1040::2",
                                     ipv6Flag=True)
    retCode = retStruct.returnCode()
    if retCode:
    ...
    LogOutput('info', "Configuring routes on the workstations")
    retStruct = host3.IPRoutesConfig(config=True, destNetwork="10.0.10.0",
                                     netMask=24, gateway="10.0.40.2")
    retCode = retStruct.returnCode()
    if retCode:
        LogOutput('error', "\nFailed to configure ipv4 address route")
    ...
    retStruct = host3.IPRoutesConfig(config=True, destNetwork="1010::0",
                                     netMask=120, gateway="1040::2",
                                     ipv6Flag=True)
    retCode = retStruct.returnCode()
    if retCode:
    ...
    LogOutput('info', "Configuring routes on the workstations")
    retStruct = host3.IPRoutesConfig(config=True, destNetwork="10.0.20.0",
                                     netMask=24, gateway="10.0.40.2")
    retCode = retStruct.returnCode()
    if retCode:
        LogOutput('error', "\nFailed to configure ipv4 address route")
    ...
    retStruct = host3.IPRoutesConfig(config=True, destNetwork="1020::0",
                                     netMask=120, gateway="1040::2",
                                     ipv6Flag=True)
    retCode = retStruct.returnCode()
    if retCode:
    ...
    retStruct = IpRouteConfig(deviceObj=switch1, route="10.0.40.0", mask=24,
                              nexthop="10.0.30.2", config=False)
    retCode = retStruct.returnCode()
    if retCode:
    ...
    retStruct = IpRouteConfig(deviceObj=switch1, route="1040::", mask=120,
                              nexthop="1030::2", config=False, ipv6flag=True)
    retCode = retStruct.returnCode()
    if retCode:
    ...
    retStruct = IpRouteConfig(deviceObj=switch2, route="10.0.10.0", mask=24,
                              nexthop="10.0.30.1", config=False)
    retCode = retStruct.returnCode()
    if retCode:
        LogOutput('error', "\nFailed to unconfigure ipv4 address route")
        # caseReturnCode = 1
    ...
    retStruct = IpRouteConfig(deviceObj=switch2, route="1010::", mask=120,
                              nexthop="1030::1", config=False, ipv6flag=True)
    retCode = retStruct.returnCode()
    if retCode:
        LogOutput('error', "\nFailed to unconfigure ipv6 address route")
        # caseReturnCode = 1
    ...
    retStruct = IpRouteConfig(deviceObj=switch1, route="10.0.40.0", mask=24,
                              nexthop="10.0.50.2", config=False)
    retCode = retStruct.returnCode()
    if retCode:
        LogOutput('error', "\nFailed to unconfigure ipv4 address route")
        # caseReturnCode = 1
    ...
    retStruct = IpRouteConfig(deviceObj=switch1, route="1040::", mask=120,
                              nexthop="1050::2", config=False, ipv6flag=True)
    retCode = retStruct.returnCode()
    if retCode:
        LogOutput('error', "\nFailed to unconfigure ipv6 address route")
        # caseReturnCode = 1
    ...
    retStruct = IpRouteConfig(deviceObj=switch2, route="10.0.10.0", mask=24,
                              nexthop="10.0.50.1", config=False)
    retCode = retStruct.returnCode()
    if retCode:
        LogOutput('error', "\nFailed to unconfigure ipv4 address route")
        # caseReturnCode = 1
    ...
    retStruct = IpRouteConfig(deviceObj=switch2, route="1010::", mask=120,
                              nexthop="1050::1", config=False, ipv6flag=True)
    retCode = retStruct.returnCode()
    if retCode:
        LogOutput('error', "\nFailed to unconfigure ipv6 address route")
        # caseReturnCode = 1
...
class Test_ecmp_ping:
    ...
    def test_ecmp_ping(self):
        ...
        retValue = ecmp_ping(switch1=dut01Obj, switch2=dut02Obj,
                             host1=wrkston01Obj, host2=wrkston02Obj,
                             host3=wrkston03Obj)
        if retValue != 0:
            assert "Test failed"
        else:
