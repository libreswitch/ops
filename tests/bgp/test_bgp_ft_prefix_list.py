...
class bgpTest(OpsVsiTest):
    ...
    def setup_bgp_config(self):
        ...
        addNbrPrefixList("8.0.0.2", "BGP%s_OUT" %(self.bgpConfig1.asn), "out")
    ...
    def apply_bgp_config(self):
        ...
        for bgp_cfg in self.bgpConfigArr:
            ...
            if bgp_cfg.asn is "1":
                ...
                self.add_neighbor_prefix_list_configs(cfg_array)
    ...
    def add_neighbor_prefix_list_configs(self, cfg_array):
    ...
    def remove_neighbor_prefix_list_configs(self, cfg_array):
...
class Test_bgpd_prefixlist:
    ...
    def setup_class(cls):
        Test_bgpd_prefixlist.test_var = bgpTest()

    def teardown_class(cls):
        Test_bgpd_prefixlist.test_var.net.stop()
