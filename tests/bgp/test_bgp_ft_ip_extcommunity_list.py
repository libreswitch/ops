...
#
#   * ip extcommunity-list WORD (permit | deny) .LINE
#   * route map <route-map-name> permit seq_num
#   *   match extcommunity-list WORD
...
# ----------------------------------------------------------------------------
# !
# ip extcommunity-list BGP_IN permit 2:0
# ip extcommunity-list BGP_IN deny 3:0
# !
# route-map BGP_RMAP permit 10
#     match extcommunity BGP_IN
# !
# router bgp 1
