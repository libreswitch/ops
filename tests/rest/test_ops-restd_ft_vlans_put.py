...
class configTest (OpsVsiTest):
    ...
    def create_fake_port(self, fake_port_name):
        ...
        response_status, response_data = request_test_utils.execute_request(path,
                                                                            "POST",
                                                                            data,
                                                                            self.switch_ip)
    ...
    def create_fake_vlan(self, bridge_name, fake_vlan_name):
        ...
        data["configuration"]["name"] = fake_vlan_name
    ...
    def test_put_vlan(self):
        ...
        response_status, response_data = request_test_utils.execute_request(self.test_path,
                                                                            "PUT",
                                                                            json.dumps(data),
                                                                            self.switch_ip)
    ...
    def run_all(self):
        ...
        self.create_fake_vlan(self.fake_bridge, self.fake_vlan)
