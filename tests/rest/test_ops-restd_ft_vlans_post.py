...
class configTest (OpsVsiTest):
    ...
    def test_post_vlan(self):
        ...
        response_status, response_data = execute_request(self.test_path, "POST", data, self.switch_ip)
    ...
    def test_post_vlan_bad_name(self):
        ...
        for field, value in data.iteritems():
            ...
            response_status, response_data = execute_request(self.test_path, "POST", json.dumps(value), self.switch_ip)
