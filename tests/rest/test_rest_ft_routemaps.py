...
class QueryRouteMaps(OpsVsiTest):
    def setupNet(self):
        ...
        self.url = "/rest/v1/system/route_maps"
...
class Test_route_maps:
    ...
    def teardown_class(cls):
        Test_route_maps.test_var.net.stop()
    ...
    def test_route_maps(self, netop_login):
        self.test_var.test_route_maps()
