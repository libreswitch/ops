...
def lldp_wait_hold(**kwargs):
    ...
    assert ((lnk01PrtStats[device1.linkPortMapping['lnk01']]['Neighbor_portID']).rstrip()) == (device2.linkPortMapping['lnk01']), "Case Failed, No Neighbor present for SW1"
    ...
    assert ((lnk01PrtStats[device2.linkPortMapping['lnk01']]['Neighbor_portID']).rstrip()) == (device1.linkPortMapping['lnk01']), "Case Failed, No Neighbor present for SW2"
