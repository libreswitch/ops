...
## ECMP
Equal Cost Multipath is a scenario where a single route can have multiple "Equal Cost" route nexthops. OpenSwitch supports 32 ECMP nexthops per prefix in the initial phase. OpenSwitch supports ECMP for IPv4 prefixes in the initial phase.
